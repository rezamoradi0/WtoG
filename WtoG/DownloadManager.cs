...
namespace MediaInfo
{
    public static class DownloadManager
    {
       ...
       public static bool InProgress = false;
        ...
        static string DonwloadLinksTxt = @"C:\SubtitleBotPlugins\DownloadLinks.txt";
        static string WrongTxt = @"C:\SubtitleBotPlugins\WrongLinks.txt";
        ...
        public static bool AddToQueu(this List<Link> AllLink)
        {
            ...
            while (AllLink.Count>0)
            {
                ...
                if (RemoteFileExists(AllLink[0].Url)&& GetFileSize(AllLink[0].Url)<1450)
                {
                    ...
                    string WrongUrl=AllLink[0].Url+Environment.NewLine;
